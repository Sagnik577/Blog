...
const aboutContent = "This post is meant to spread awareness about the gifted natural herb namely weed or reefer or ganja or pot or whatever name you want to call it, to the general public who are unaware by going into '/compose' route and sharing your experience of this herb by posting it withyour name in the 'Title' section.This post would be accessible by all so everyone can read it and know about it....only you have to post your experience and then share this link to the maximum number of audience as much as you can.....so let's go!!";
const contactContent = "You can contact the members who have taken the initiative of this step in order to spread this wareness among all so that it can reach the government and we all can legally enjoy the stuff and get inspired to work to our best:";
